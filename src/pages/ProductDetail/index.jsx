                ...
                <div className="product-gallery product-gallery-vertical">
                  <div className="row">
                    <figure className="product-main-image">
                      <img
                        id="product-zoom"
                        src="/src/assets/images/products/single/1.jpg"
                        data-zoom-image="/src/assets/images/products/single/1-big.jpg"
                        alt="product image"
                      />
                      <div
                    ...
                    >
                      <a
                        ...
                        href="#"
                        data-image="/src/assets/images/products/single/1.jpg"
                        data-zoom-image="/src/assets/images/products/single/1-big.jpg"
                      >
                        <img
                          src="/src/assets/images/products/single/1-small.jpg"
                      ...
                      <a
                        ...
                        href="#"
                        data-image="/src/assets/images/products/single/2-big.jpg"
                        data-zoom-image="/src/assets/images/products/single/2-big.jpg"
                      >
                        <img
                          src="/src/assets/images/products/single/2-small.jpg"
                          alt="Dark yellow lace"
                        />
                      </a>
                      <a
                        className="product-gallery-item"
                        href="#"
                        data-image="/src/assets/images/products/single/3-big.jpg"
                        data-zoom-image="/src/assets/images/products/single/3-big.jpg"
                      >
                        <img
                          src="/src/assets/images/products/single/3-small.jpg"
                          alt="Dark yellow lace"
                        />
                      </a>
                      <a
                        className="product-gallery-item"
                        href="#"
                        data-image="/src/assets/images/products/single/4-big.jpg"
                        data-zoom-image="/src/assets/images/products/single/4-big.jpg"
                      >
                        <img
                          src="/src/assets/images/products/single/4-small.jpg"
                          alt="Dark yellow lace"
                        />
                      </a>
                    </div>
