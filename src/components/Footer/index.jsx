          ...
          <div className="row">
            ...
            <div className="col-sm-6 col-lg-2">
              <div className="widget">
                ...
                <ul className="widget-list">
                  <li>
                    <NavLink to={PATHS.PAYMENTMETHOD}>Payment Methods</NavLink>
                  </li>
                  <li>
            ...
            <div className="col-sm-6 col-lg-2">
              <div className="widget">
                ...
                <ul className="widget-list">
                  ...
                  <li>
                    <Link to={PATHS.PRODUCT_CART}>View Cart</Link>
                  </li>
                  <li>
                    <Link to={PATHS.MYACCOUNT.WHISHLIST}>My Wishlist</Link>
                  </li>
                  <li>
                    <Link to={PATHS.MYACCOUNT.ORDER}>Track My Order</Link>
                  </li>
                </ul>
              </div>
            </div>
